...
from odoo.addons.account_reports_community.report.xlsx_export import build_xlsx
...
REPORT_XMLIDS = [
    'account_reports_community.trial_balance_report',
    'account_reports_community.general_ledger_report',
    'account_reports_community.partner_ledger_report',
    'account_reports_community.aged_receivable_report',
    'account_reports_community.tax_report_community',
    'account_reports_community.journal_report_community',
]
    ...
    def test_pdf_export_renders_non_empty_content_for_every_report(self):
        ...
        for xmlid in REPORT_XMLIDS:
            ...
            content, report_type = self.env['ir.actions.report']._render_qweb_pdf(
                'account_reports_community.account_report_pdf_action',
                res_ids=None,
