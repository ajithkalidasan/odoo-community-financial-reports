...
class TestProfitAndLoss(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.report = cls.env.ref('account_reports_community.profit_and_loss_report')
    ...
    def test_category_expands_into_accounts_with_codes(self):
        ...
        operating_expenses_line = self.env.ref('account_reports_community.pl_line_expense_operating')
