...
class TestBalanceSheet(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.report = cls.env.ref('account_reports_community.balance_sheet_report')
    ...
    def test_category_expands_into_accounts_with_codes(self):
        ...
        current_assets_line = self.env.ref('account_reports_community.bs_line_assets_current')
