...
PDF_REPORT_XMLID = 'account_reports_community.account_report_pdf_action'
...
class AccountReportsCommunityController(http.Controller):
    ...
    @http.route('/account_reports_community/xlsx', type='http', auth='user', methods=['POST'], readonly=True)
    ...
    @http.route('/account_reports_community/pdf', type='http', auth='user', methods=['POST'])
